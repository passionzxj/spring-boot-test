package com.code.gen.out.operateLog;//package com.zhang.operateLog;
//
//import com.alibaba.fastjson.JSON;
//import com.zhang.annotation.OperLog;
//import com.zhang.annotation.OperationLog;
//import com.zhang.annotation.OperationLogService;
//import com.zhang.util.LoginSourceUtil;
...
//     */
//    @Pointcut("@annotation(com.zhang.annotation.OperLog)")
...
////     */
////    @Pointcut("execution(* com.zhang.web.controller..*.*(..))")
...
//        try {
//            operlog.setId(UUID.randomUUID().toString()); // 主键ID
...
//            operlog.setOperIp(LoginSourceUtil.getIp(request)); // 请求IP
